...
class ConnectionManager:
    ...
    def _connect_databricks(self):
        """Connect to Databricks. Requires databricks-sql-connector."""
        try:
        ...
        self._connection = databricks_sql.connect(
            server_hostname=conn_config.get("server_hostname", ""),
            http_path=conn_config.get("http_path", ""),
            access_token=conn_config.get("access_token", ""),
            catalog=conn_config.get("catalog", ""),
            schema=conn_config.get("schema", "default"),
        )
        self._schema_prefix = conn_config.get("schema", "default")
